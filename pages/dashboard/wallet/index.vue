      ...
      <div class="bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h2 class="text-lg font-bold">{{userData.name ?? 'Nil'}}</h2>
              <p class="text-gray-400">{{userData.email ?? 'Nil'}}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div class="bg-gray-700 rounded-lg p-4">
            ...
            <p class="text-2xl font-bold">${{userData.accountBalance ?? 'Nil'}}</p>
          </div>
          <div class="bg-gray-700 rounded-lg p-4">
        ...
        <div class="flex justify-between items-center">
          <div>
            ...
            <p class="text-3xl font-bold">${{userData.accountBalance ?? 'Nil'}}</p>
          </div>
          <div>
