      ...
      <!-- <div class="bg-gray-900 min-h-screen p-8"> -->
        <div class="max-w-6xl  bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          <div class="grid grid-cols-1  lg:grid-cols-2 gap-6">
            <div @click="router.push(`/dashboard/withdrawal/new-withdrawal`)" v-for="option in withdrawalOptions" :key="option.title" class="bg-white cursor-pointer rounded-lg shadow-md p-6">
