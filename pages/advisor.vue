<template>
  <main>
    <div>
      <div
        class="relative isolate overflow-hidden bg-[#fcfcd0] px-6 pt-32 text-center"
      >
        <h2
          class="mx-auto max-w-2xl text-3xl font-medium tracking-tight text-gray-800 sm:text-4xl"
        >
          The RIA custodian helping power your growth
        </h2>
        <p class="mx-auto mt-6 max-w-xl text-base leading-8 text-gray-900">
          As your end-to-end custodian, our cutting-edge technology can help you
          scale your practice and deliver a high-quality, personalized client
          experience.
        </p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a
            href="#"
            class="rounded-sm bg-blue-500 px-6 py-3 text-sm font-semibold shadow-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >Schedule a demo</a
          >
        </div>
        <p
          class="mx-auto text-blue-800 mt-6 max-w-xl leading-8 text-sm font-sm"
        >
          Looking to advise a 401(k)?
        </p>
      </div>
      <img src="@/assets/img/advisor-hero.png" alt="" />
    </div>

    <div class="text-[#000b50] bg-[#000b50]">
          ...
          <div class="mt-16 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
            <div class="sm:flex lg:block">
              <div class="sm:flex-shrink-0">
                ...
                >
                  ...
                  <path
                    fill-rule="evenodd"
                    d="M22.3 18v-6h3.4v6h-3.4z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M22.3 36v-6h3.4v6h-3.4z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M19.7 28.5l-5.2 3-1.8-3 5.2-3 1.8 3z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M35.3 19.5l-5.2 3-1.8-3 5.2-3 1.8 3z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M18 22.5l-5.3-3 1.8-3 5.2 3-1.8 3z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M33.5 31.5l-5.2-3 1.8-3 5.2 3-1.8 3z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M24 28.5a4.5 4.5 0 100-9 4.5 4.5 0 000 9zm0 3.5a8 8 0 100-16 8 8 0 000 16z"
                    clip-rule="evenodd"
                  ></path>
                </svg>
              </div>
              <div class="mt-4 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                ...
                <p class="mt-2 text-sm text-white">
                  Our vertically integrated solution helps you build and manage
                  custom model portfolios with options you can enable like
                  automated trading, rebalancing, tax-loss harvesting, asset
                  location, and more.
                </p>
              </div>
            </div>
            <div class="sm:flex lg:block">
              <div class="sm:flex-shrink-0">
                ...
                >
                  <path
                    fill-rule="currentColo"
                    d="M43.7 17.8h-39v-3.6h39v3.6z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M42 9.5H6c-.3 0-.5.2-.5.5v28c0 .3.2.5.5.5h36c.3 0 .5-.2.5-.5V10c0-.3-.2-.5-.5-.5zM6 6a4 4 0 00-4 4v28a4 4 0 004 4h36a4 4 0 004-4V10a4 4 0 00-4-4H6z"
                    clip-rule="evenodd"
                  ></path>
                  <path d="M10 32V22h10L10 32z"></path>
                  <path
                    fill-rule="evenodd"
                    d="M18.8 33.2l-8-8 2.4-2.4 8 8-2.4 2.4z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M24 25h16v-3.4H24V25z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M24 33h12v-3.4H24V33z"
                    clip-rule="evenodd"
                  ></path>
                </svg>
              </div>
              <div class="mt-4 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                ...
                <p class="mt-2 text-sm text-white">
                  Set up client accounts and transfer assets onto the Betterment
                  for Advisors platform in a cinch with our streamlined
            ...
            <div class="sm:flex lg:block">
              <div class="sm:flex-shrink-0">
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M14 14.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm0 3.5a6 6 0 100-12 6 6 0 000 12z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M34 14.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm0 3.5a6 6 0 100-12 6 6 0 000 12z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M18.5 38.5V28a4.5 4.5 0 10-9 0v10.5h9zM14 20a8 8 0 00-8 8v14h16V28a8 8 0 00-8-8z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    d="M38.5 38.5V28a4.5 4.5 0 10-9 0v10.5h9zM34 20a8 8 0 00-8 8v14h16V28a8 8 0 00-8-8z"
                    clip-rule="evenodd"
                  ></path>
                </svg>
              </div>
              <div class="mt-4 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                ...
                <p class="mt-2 text-sm text-white">
                  We’re here to help you grow – your dedicated relationship
                  manager and our operations and customer service teams partner
                  with you to scale your practice without needing to hire
                  internally.
                </p>
              </div>
            </div>
      ...
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl">
          ...
          <p class="hidden text-gray-900 md:mt-4 md:block leading-loose">
            Leverage automated, tax-efficient tools designed to help manage your
            clients' investments and minimize tax impact on returns, all while
            streamlining administrative tasks like client onboarding, account
    ...
    >
      ...
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl">
          <h2 class="text-2xl font-bold text-gray-900 md:text-3xl">
            Efficient portfolio building tools.
          </h2>

          <p class="hidden text-gray-900 md:mt-4 md:block leading-loose">
            Construct your own models with our custom model portfolio builder,
            or select from a number of expert-built options in our model
            marketplace. Serve your clients' needs in a way that meets their
    ...
    >
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl">
          <h2 class="text-2xl font-bold text-gray-900 md:text-3xl">
            A better client portal.
          </h2>

          <p class="hidden text-gray-900 md:mt-4 md:block leading-loose">
            Our robust self-directed client experience enables your clients to
            get a clear view of their wealth with portfolio analysis, retirement
            planning, and performance tracking tools.
          </p>
        </div>
      </div>
    ...
    <div class="bg-[#e3f8ff] py-16">
      <div
        class="relative isolate overflow-hidden bg-[#e3f8ff] px-6 text-center"
      >
        <h2
          class="mx-auto max-w-2xl text-3xl font-medium tracking-tight text-gray-800 sm:text-4xl"
        >
        ...
        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-900">
          Betterment's seamless integration with other well-known tools means a
      ...
      <div class="flex justify-center items-center py-10">
        <img src="@/assets/img/supports.png" class="h-44 w-auto" alt="" />
      </div>
    </div>
    ...
    <div class="w-full relative">
     ...
     <div class="absolute inset-x-0 top-0 pt-10 lg:pt-44">
      <div class="flex justify-center items-center flex-col">
        <h1 class="flex justify-center items-center text-center text-lg lg:text-3xl">Ready to accelerate your firm's growth?</h1>
