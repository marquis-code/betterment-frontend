import{u as a}from"./user.18d1d1bb.js";import{r as n,q as l}from"./entry.fa9cac2e.js";const{token:c}=a();function p(){const r=n(!1),t=n(null),o=async()=>{r.value=!0;const s=`
      query {
        getUser {
          id
          name
