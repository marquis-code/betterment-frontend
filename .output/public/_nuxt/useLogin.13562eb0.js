import{r as t,u as l,B as c}from"./entry.8102741e.js";import{u as d}from"./user.655c7c7f.js";const r=t({email:"",password:""});function y(){const{$toast:s}=c(),{createUser:o}=d(),a=t(!1),n=l();return{processing:a,handleLogin:async()=>{a.value=!0;const u=`
      mutation {
