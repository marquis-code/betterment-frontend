import{r as t,u as l,B as c}from"./entry.0b1f59d1.js";import{u as d}from"./user.9a8d007b.js";const r=t({email:"",password:""});function y(){const{$toast:s}=c(),{createUser:o}=d(),a=t(!1),n=l();return{processing:a,handleLogin:async()=>{a.value=!0;const u=`
      mutation {
