import{r as u,z as n,q as m,B as h}from"./entry.d021d1c2.js";import{u as T}from"./user.d31346c8.js";function w(){const o=u(!1),{token:l}=T(),e=u([]),{$toast:p}=h(),s=async()=>{o.value=!0;const t=`
      query {
        getTransactions {
          id
          amount
