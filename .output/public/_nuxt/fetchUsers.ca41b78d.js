import{r as a,q as i,B as l}from"./entry.fa9cac2e.js";import{u as p}from"./user.18d1d1bb.js";function g(){const{$toast:n}=l(),r=a(!1),t=a([]),{token:c}=p(),s=async()=>{r.value=!0;const u=`
      query {
        getUsers {
          id
          name
