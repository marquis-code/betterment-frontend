import{r as a,q as i,B as l}from"./entry.8102741e.js";import{u as p}from"./user.655c7c7f.js";function g(){const{$toast:n}=l(),r=a(!1),t=a([]),{token:c}=p(),s=async()=>{r.value=!0;const u=`
      query {
        getUsers {
          id
          name
