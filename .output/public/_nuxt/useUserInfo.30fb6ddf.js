import{u as a}from"./user.655c7c7f.js";import{r as n,q as l}from"./entry.8102741e.js";const{token:c}=a();function p(){const r=n(!1),t=n(null),o=async()=>{r.value=!0;const s=`
      query {
        getUser {
          id
          name
