<template>
<footer class="bg-blue-800 text-white" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul role="list" class="mt-6 space-y-4">
                ...
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Analytics</a>
                </li>
                <li>
            ...
            <div class="mt-10 md:mt-0">
              ...
              <ul role="list" class="mt-6 space-y-4">
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Pricing</a>
                </li>
                <li>
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul role="list" class="mt-6 space-y-4">
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">About</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Blog</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Jobs</a>
                </li>
                <li>
            ...
            <div class="mt-10 md:mt-0">
              ...
              <ul role="list" class="mt-6 space-y-4">
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Claim</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Privacy</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-white hover:text-white">Terms</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-white">The latest news, articles, and resources, sent to your inbox weekly.</p>
        </div>
