import{u as a}from"./user.9a8d007b.js";import{r as n,q as l}from"./entry.0b1f59d1.js";const{token:c}=a();function p(){const r=n(!1),t=n(null),o=async()=>{r.value=!0;const s=`
      query {
        getUser {
          id
          name
