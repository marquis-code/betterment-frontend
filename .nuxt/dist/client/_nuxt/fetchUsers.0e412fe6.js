import{r as a,q as i,B as l}from"./entry.0b1f59d1.js";import{u as p}from"./user.9a8d007b.js";function g(){const{$toast:n}=l(),r=a(!1),t=a([]),{token:c}=p(),s=async()=>{r.value=!0;const u=`
      query {
        getUsers {
          id
          name
