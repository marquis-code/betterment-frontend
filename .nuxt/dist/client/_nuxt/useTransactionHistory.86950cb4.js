import{r as u,z as n,q as m,B as h}from"./entry.8102741e.js";import{u as T}from"./user.655c7c7f.js";function w(){const o=u(!1),{token:l}=T(),e=u([]),{$toast:p}=h(),s=async()=>{o.value=!0;const t=`
      query {
        getTransactions {
          id
          amount
